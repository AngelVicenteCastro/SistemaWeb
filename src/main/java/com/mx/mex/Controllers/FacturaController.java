...
public class FacturaController {
	...
	@ResponseBody
	@RequestMapping(value= "/generarFactura",method=RequestMethod.GET,produces="application/json")
	public ResponseEntity < ResponseDto> insertTrabajadores() {
		final HttpHeaders httpHeaders = new HttpHeaders();
	              ...
	              //SINO ES VIGENTE NO LE PERMITE FACTURA, 
	                ...
	                //else{ //SI ES VIGENTE,  
	                    ...
	                    //if(contribuyenteValido(contribuyente)){//ACTUALIZA O AGREGA EL RFC Y GENERA LA FACTURA
	                        ...
	                        comprobante.setFolio("2500"); //SE MANDA NUMERO DE TICKET
	                     ...
	                     comprobante.setImpuesto(impuestoComprobante);//SE AGREGAN LOS IMPUESTOS A NIVEL COMPROBANTE
	                        ...
	                        receptor.setEmailContacto("casangel97@gmail.com");
		    ...
		    respuesta.setMessage(respuestaFactura);
		    respuesta.setCode(0);
